...
- **视觉友好**：有 UI 的项目添加截图或 GIF，并提供描述性 alt 文本
...
直接生成并写入 README.md，告知用户文件路径。如需调整，可继续提出修改意见。

若用户在请求中明确要求预览（如"先给我看看"、"预览一下"），则先展示内容，用户确认后再写入。

...
description: >
  前端代码精炼技能。对 Vue2/Vue3/React 组件与 JS/TS/JSX/TSX 文件执行精炼——清理无效代码、整理导入排序、统一代码结构、规范命名、增强 Props。
  触发场景：代码精炼、清理冗余代码、整理导入排序、规范化命名、Props 增强、死代码清理、tidy up imports 等。

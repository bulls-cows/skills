...
- **禁止**运行任何非只读工具
- **禁止**对系统进行任何更改
- **禁止**以"任务简单"或"意图明显"为由跳过展示规格、等待确认的步骤
...
已创建以下规格文件：
1. D:/project/.claude/specs/20260324_153045_实时通知系统/spec.md - 主规格文档
2. D:/project/.claude/specs/20260324_153045_实时通知系统/tasks.md - 任务分解（4个任务）
3. D:/project/.claude/specs/20260324_153045_实时通知系统/checklist.md - 验证清单

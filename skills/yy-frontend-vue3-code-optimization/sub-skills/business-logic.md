...
2. **数据流向**：
   - **数据来源**：props 传入、API 请求、Store 注入、本地 ref/reactive 初始化
 ...
 * - ref: searchQuery (查询条件)、tableData (列表数据)、loading (加载状态)
 * - Hooks: useTable (表格数据管理)、useSearchForm (搜索表单)
 *
 * 交互关系:

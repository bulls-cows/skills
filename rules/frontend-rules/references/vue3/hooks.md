...
> Hooks 通用规则（命名、文件组织、抽离建议、返回值、注释规范）详见 [@rules/frontend-rules/references/common-hooks.md](../common-hooks.md)，本文件仅承载 Vue3 特有内容。
...
- 组件引入后按注释规范标注：`// hook: Hook名`（详见 [../comments.md](../comments.md)）

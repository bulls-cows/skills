...
- [@rules/frontend-rules/references/common-hooks.md](../common-hooks.md) — Hooks 通用规范
- [@rules/frontend-rules/references/common-typescript.md](../common-typescript.md) — TypeScript 通用规范
...
组件内部代码顺序、文件结构、Import 分组、JSX 属性顺序详见 [order.md](./order.md)。

---

## 四、Props 规范

详见 [interaction.md](./interaction.md#一props-规范)（单向数据流、参数解构、默认值、布尔简写、字符串 props）。

Props 的 TypeScript 类型定义详见 [typescript.md](./typescript.md#一props-类型定义)。
...
Import 分组排序规则详见 [order.md](./order.md#三import-分组排序4-组)。

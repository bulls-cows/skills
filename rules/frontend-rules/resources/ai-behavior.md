...
1. **禁止越权修改**：不得修改授权目录之外的任何文件，不得修改其他业务模块代码，除非用户明确指定并授权
...
6. **禁止使用 `any` 类型**：TypeScript 代码中不得使用 `any`、`@ts-ignore`、`@ts-expect-error`，除非用户明确允许（详见 [common-typescript.md](./common-typescript.md#二禁用-any)）
...
2. **注释优化**：修改、补充代码中的注释和 JSDoc，提升可读性（遵循 [common-comments.md](./common-comments.md#四注释保护原则)）

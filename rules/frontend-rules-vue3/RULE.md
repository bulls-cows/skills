...
- **[@rules/frontend-rules-vue3/references/order.md](./references/order.md)** — SFC 结构顺序与导入分组（11 组）
...
- **[@rules/frontend-rules-vue3/references/typescript.md](./references/typescript.md)** — TypeScript 类型注解规范（禁止 any）
...
| 结构顺序 | 11 组 import 排序、`<script setup>` 内部 10 段结构 |
...
| TypeScript | 禁止 any、类型注解、import type |
